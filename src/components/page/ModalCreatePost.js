...
ModalCreatePost.prototype = {
  getAllPosts: PropTypes.object
};
function ModalCreatePost({ getAllPosts }) {
  ...
  const post = () => {
    if (type === 'text') {
      const post = {
        ...
        pageId: modalCreatePostPage.page.id
      };
      dispatch(
        actionUserBackdrop({
          status: false,
  ...
  return (
    <Modal open={modalCreatePostPage.status} onClose={handleClose}>
      <BoxModal>
        ...
        <Grid container spacing={2}>
          <Grid item xs={1} sm={1} md={1} lg={1} xl={1}>
            <Avatar src={modalCreatePostPage.page.avatar} />
          </Grid>
